...
$results = shell_exec("/opt/ic-commp/bin/python3 /opt/ic-commp/ic-commp/startup.py $pmu $time_window $sample_frequency $segmentWindow $segmentOverlap $filter_lower $filter_higher $outlier_constant");
